...
result = client.predict(
				...
				"1152×986",	# str in 'Aspect Ratios' Radio component
				1,	# int | float (numeric value between 1 and 32)in 'Image Number' Slider component
				"2342342",	# str in 'Seed' Textbox component
				...
				"Howdy!",	# str in 'parameter_82' Textbox component
				"Disabled",	# str in 'Upscale or Variation:' Radio component
				"base.png",	# str (filepath or URL to image)in 'Drag above image to here' Image component
				["Left"],	# List[str] in 'Outpaint Direction' Checkboxgroup component
				"base.png",	# str (filepath or URL to image)in 'Drag above image to here' Image component
				"Howdy!",	# str in 'Inpaint Additional Prompt' Textbox component
				"base.png",	# str (filepath or URL to image)in 'Image' Image component
